...
public class Interpreter {
    ...
    public void setupBuiltins() {
        Value.Closure read = new Value.Closure(new Stmt.FuncDef("read", List.of("filename"), new Stmt.Read(), new Expr.Var("return")), globalFrame);
        Value.Closure plus = new Value.Closure(new Stmt.FuncDef("plus", List.of("a",   "b"), new Stmt.Plus(), new Expr.Var("return")), globalFrame);

        declareFunction("read", read);
        declareFunction("plus", plus);
    }
