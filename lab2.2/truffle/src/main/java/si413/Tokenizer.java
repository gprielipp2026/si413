...
public class Tokenizer {
    ...
    /** This error is thrown when something is wrong with the tokenSpec.txt file. */
    public static class SpecError extends IOException {
            ...
            throws IOException
    {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(specFile))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (!mat.matches()) {
                    throw new SpecError(String.format("Improper token spec line: '%s'", line));
                }
                ...
                if (tokName == null) {
                    ...
                    if (tokType == Token.INVALID_TYPE) {
                        throw new SpecError(String.format("Token %s not found in vocab", tokName));
                    }
                }
