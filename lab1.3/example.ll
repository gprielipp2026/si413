...
%var0 = call ptr @concat(ptr @lit10, ptr @lit11)
call i32 @puts(ptr %var0)
call i32 @puts(ptr @lit12)
%var1 = call ptr @getUserInput()
%var2 = call ptr @concat(ptr @lit13, ptr %var1)
call i32 @puts(ptr %var2)
%var3 = call ptr @reverseString(ptr @lit14)
call i32 @puts(ptr %var3)
call i32 @puts(ptr @lit15)
%var4 = call ptr @getUserInput()
%var5 = call ptr @reverseString(ptr %var4)
%var6 = call ptr @reverseString(ptr @lit16)
%var7 = call ptr @concat(ptr %var5, ptr %var6)
call i32 @puts(ptr %var7)
%var8 = call ptr @getUserInput()
%var9 = call ptr @concat(ptr @lit17, ptr %var8)
call i32 @puts(ptr %var9)
%var10 = call ptr @getUserInput()
%var11 = call ptr @concat(ptr @lit18, ptr %var10)
%var12 = call ptr @reverseString(ptr %var11)
call i32 @puts(ptr %var12)
ret i32 0
}

@lit0 = constant [43 x i8] c"string literal, nothing should happen here\00"
@lit1 = constant [22 x i8] c"this should print out\00"
@lit2 = constant [1 x i8] c"\00"
@lit3 = constant [31 x i8] c"above should be an empty print\00"
@lit4 = constant [19 x i8] c"print this out too\00"
@lit5 = constant [28 x i8] c"this has a comment after it\00"
@lit6 = constant [5 x i8] c"junk\00"
@lit7 = constant [10 x i8] c"more junk\00"
@lit8 = constant [11 x i8] c"space junk\00"
@lit9 = constant [18 x i8] c" spaces in print \00"
@lit10 = constant [12 x i8] c"concatenate\00"
@lit11 = constant [8 x i8] c" me now\00"
@lit12 = constant [17 x i8] c"Enter your name:\00"
@lit13 = constant [7 x i8] c"Hello \00"
@lit14 = constant [9 x i8] c"reversed\00"
@lit15 = constant [17 x i8] c"Enter your name:\00"
@lit16 = constant [8 x i8] c"Hello: \00"
@lit17 = constant [7 x i8] c"Hello \00"
@lit18 = constant [14 x i8] c"Your name is \00"
